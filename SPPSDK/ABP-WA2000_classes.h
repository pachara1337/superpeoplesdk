...
struct UABP-WA2000_C : UBravoHotelAnimInstanceWeapon {
	...
	void AnimGraph(struct FPoseLink& AnimGraph); // Function ABP-WA2000.ABP-WA2000_C.AnimGraph // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x2bad3b0
	void ExecuteUbergraph_ABP-WA2000(int32_t EntryPoint); // Function ABP-WA2000.ABP-WA2000_C.ExecuteUbergraph_ABP-WA2000 // (Final|UbergraphFunction) // @ game+0x2bad3b0
};
