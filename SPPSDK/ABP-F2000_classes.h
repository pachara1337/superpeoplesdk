...
struct UABP-F2000_C : UBravoHotelAnimInstanceWeapon {
	...
	struct FAnimNode_RefPose AnimGraphNode_LocalRefPose; // 0x880(0x18)
	struct FAnimNode_Slot AnimGraphNode_Slot; // 0x898(0x50)
	...
	void AnimGraph(struct FPoseLink& AnimGraph); // Function ABP-F2000.ABP-F2000_C.AnimGraph // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x2bad3b0
	void ExecuteUbergraph_ABP-F2000(int32_t EntryPoint); // Function ABP-F2000.ABP-F2000_C.ExecuteUbergraph_ABP-F2000 // (Final|UbergraphFunction) // @ game+0x2bad3b0
};
