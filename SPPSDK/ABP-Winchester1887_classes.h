...
struct UABP-Winchester1887_C : UBravoHotelAnimInstanceWeapon {
	...
	void AnimGraph(struct FPoseLink& AnimGraph); // Function ABP-Winchester1887.ABP-Winchester1887_C.AnimGraph // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x2bad3b0
	void ExecuteUbergraph_ABP-Winchester1887(int32_t EntryPoint); // Function ABP-Winchester1887.ABP-Winchester1887_C.ExecuteUbergraph_ABP-Winchester1887 // (Final|UbergraphFunction) // @ game+0x2bad3b0
};
