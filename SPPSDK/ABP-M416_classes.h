...
struct UABP-M416_C : UBravoHotelAnimInstanceWeapon {
	...
	struct FAnimNode_RefPose AnimGraphNode_LocalRefPose; // 0x818(0x18)
	struct FAnimNode_Slot AnimGraphNode_Slot; // 0x830(0x50)
	...
	void AnimGraph(struct FPoseLink& AnimGraph); // Function ABP-M416.ABP-M416_C.AnimGraph // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x2bad3b0
	void ExecuteUbergraph_ABP-M416(int32_t EntryPoint); // Function ABP-M416.ABP-M416_C.ExecuteUbergraph_ABP-M416 // (Final|UbergraphFunction) // @ game+0x2bad3b0
};
