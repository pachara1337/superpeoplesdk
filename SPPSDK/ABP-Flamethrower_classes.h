...
struct UABP-Flamethrower_C : UBravoHotelAnimInstanceWeapon {
	...
	void AnimGraph(struct FPoseLink& AnimGraph); // Function ABP-Flamethrower.ABP-Flamethrower_C.AnimGraph // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x2bad3b0
	void ExecuteUbergraph_ABP-Flamethrower(int32_t EntryPoint); // Function ABP-Flamethrower.ABP-Flamethrower_C.ExecuteUbergraph_ABP-Flamethrower // (Final|UbergraphFunction) // @ game+0x2bad3b0
};
