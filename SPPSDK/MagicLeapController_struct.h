...
// Size: 0x2cff6c34 (Inherited: 0x00)
struct FMagicLeapTouchpadGesture {
	enum class EControllerHand Hand; // 0x00(0x01)
	char pad_1[0x3]; // 0x01(0x03)
	struct FName MotionSource; // 0x04(0x0c)
	enum class EMagicLeapTouchpadGestureType Type; // 0x10(0x01)
	enum class EMagicLeapTouchpadGestureDirection Direction; // 0x11(0x01)
	char pad_12[0x2]; // 0x12(0x02)
	struct FVector PositionAndForce; // 0x14(0x0c)
	float Speed; // 0x20(0x04)
	float Distance; // 0x24(0x04)
	float FingerGap; // 0x28(0x04)
	float Radius; // 0x2c(0x04)
	float Angle; // 0x30(0x04)
	char pad_34[0x2cff6c00]; // 0x34(0x2cff6c00)
};
