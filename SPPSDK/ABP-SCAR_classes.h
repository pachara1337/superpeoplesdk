...
struct UABP-SCAR_C : UBravoHotelAnimInstanceWeapon {
	...
	void AnimGraph(struct FPoseLink& AnimGraph); // Function ABP-SCAR.ABP-SCAR_C.AnimGraph // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x2bad3b0
	void ExecuteUbergraph_ABP-SCAR(int32_t EntryPoint); // Function ABP-SCAR.ABP-SCAR_C.ExecuteUbergraph_ABP-SCAR // (Final|UbergraphFunction) // @ game+0x2bad3b0
};
