...
struct UABP-M16_C : UBravoHotelAnimInstanceWeapon {
	...
	void AnimGraph(struct FPoseLink& AnimGraph); // Function ABP-M16.ABP-M16_C.AnimGraph // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x2bad3b0
	void ExecuteUbergraph_ABP-M16(int32_t EntryPoint); // Function ABP-M16.ABP-M16_C.ExecuteUbergraph_ABP-M16 // (Final|UbergraphFunction) // @ game+0x2bad3b0
};
