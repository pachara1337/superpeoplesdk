...
struct UABP-PPSH41_C : UBravoHotelAnimInstanceWeapon {
	...
	void AnimGraph(struct FPoseLink& AnimGraph); // Function ABP-PPSH41.ABP-PPSH41_C.AnimGraph // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x2bad3b0
	void ExecuteUbergraph_ABP-PPSH41(int32_t EntryPoint); // Function ABP-PPSH41.ABP-PPSH41_C.ExecuteUbergraph_ABP-PPSH41 // (Final|UbergraphFunction) // @ game+0x2bad3b0
};
