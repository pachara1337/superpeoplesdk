...
enum class ERenderingStyle : uint8 {
...
enum class EDecalDetailRenderingMode : uint8 {
	DDRM_Low = 0,
	DDRM_Medium = 1,
	DDRM_High = 2,
	DDRM_MAX = 3
...
// Size: 0x2cff6a14 (Inherited: 0x2cff6a10)
struct FMaterialAttributesInput : FExpressionInput {
	int32_t PropertyConnectedBitmask; // 0x10(0x04)
};
...
// Size: 0x2cff6a10 (Inherited: 0x2cff6a10)
...
// Size: 0x2cff6c90 (Inherited: 0x00)
struct FHitResult {
	...
	char pad_90[0x2cff6c00]; // 0x90(0x2cff6c00)
};

// ScriptStruct Engine.Vector_NetQuantize
// Size: 0x2cff6b0c (Inherited: 0x2cff6a0c)
struct FVector_NetQuantize : FVector {
	char pad_2CFF6A0C[0x100]; // 0x2cff6a0c(0x100)
};

// ScriptStruct Engine.Vector_NetQuantizeNormal
// Size: 0x2cff6a0c (Inherited: 0x2cff6a0c)
...
struct FMKReplayListItemInfo {
	...
	struct TArray<struct FMKReplayTeamInfo> TeamInfos; // 0xb0(0x10)
	float KillcamStartTime; // 0xc0(0x04)
	float KillcamEndTime; // 0xc4(0x04)
	bool bHaveCameraEvent; // 0xc8(0x01)
	char pad_C9[0x7]; // 0xc9(0x07)
	struct FString AdditionalInfo; // 0xd0(0x10)
	int32_t MK3DReplayVersion; // 0xe0(0x04)
	int32_t NetworkVersion; // 0xe4(0x04)
	bool bSinglePlayRecord; // 0xe8(0x01)
	char pad_E9[0x3]; // 0xe9(0x03)
	int32_t TournamentStep; // 0xec(0x04)
	int32_t TournamentLeague; // 0xf0(0x04)
	int32_t TournamentRound; // 0xf4(0x04)
	struct FString PlayZoneName; // 0xf8(0x10)
	int32_t PlayZoneInfoIndex; // 0x108(0x04)
	char pad_10C[0x4]; // 0x10c(0x04)
	struct TArray<struct FReplayKillEvent> KillEvent; // 0x110(0x10)
	struct FMKReplayReportInfo ReportInfo; // 0x120(0x28)
	char pad_148[0x2cff6800]; // 0x148(0x2cff6800)
};
...
struct FReplayKillEvent {
	...
	char pad_24[0x2cffdf04]; // 0x24(0x2cffdf04)
};
...
struct FBranchingPointNotifyPayload {
	char pad_0[0x2cff6b20]; // 0x00(0x2cff6b20)
};
...
struct FSimpleMemberReference {
	...
	char pad_24[0x2cff6c04]; // 0x24(0x2cff6c04)
};
...
struct FTickFunction {
	...
	char pad_10[0x2cff6a18]; // 0x10(0x2cff6a18)
};
...
struct FInterpControlPoint {
	...
	char pad_D[0x2cff6a0f]; // 0x0d(0x2cff6a0f)
};
...
struct FURL {
	...
	char pad_68[0x2cff6a00]; // 0x68(0x2cff6a00)
};
...
// Size: 0x2cff6d0c (Inherited: 0x2cff6a0c)
struct FVector_NetQuantize100 : FVector {
	char pad_2CFF6A0C[0x300]; // 0x2cff6a0c(0x300)
};

// ScriptStruct Engine.RepMovement
// Size: 0x2cffcd34 (Inherited: 0x00)
struct FRepMovement {
	...
	char pad_34[0x2cffcd00]; // 0x34(0x2cffcd00)
};

// ScriptStruct Engine.ActorTickFunction
// Size: 0x2cffd830 (Inherited: 0x2cff6a28)
struct FActorTickFunction : FTickFunction {
	char pad_2CFF6A28[0x6e08]; // 0x2cff6a28(0x6e08)
};

// ScriptStruct Engine.UniqueNetIdRepl
// Size: 0x2cff6928 (Inherited: 0x2cff6a01)
...
struct FForceFeedbackParameters {
	...
	char pad_F[0x2cff6a01]; // 0x0f(0x2cff6a01)
};
...
struct FUpdateLevelVisibilityLevelInfo {
	...
	char pad_19[0x2cff6a03]; // 0x19(0x2cff6a03)
};
...
struct FActiveForceFeedbackEffect {
	...
	char pad_8[0x2cff6a18]; // 0x08(0x2cff6a18)
};
...
struct FFractureEffect {
	...
	char pad_11[0x2cff6b07]; // 0x11(0x2cff6b07)
};

// ScriptStruct Engine.RootMotionSourceGroup
// Size: 0x2cff9c38 (Inherited: 0x00)
struct FRootMotionSourceGroup {
	...
	char pad_38[0x2cff9c00]; // 0x38(0x2cff9c00)
};
...
// Size: 0x2cff9698 (Inherited: 0x00)
struct FRepRootMotionMontage {
	...
	char pad_98[0x2cff9600]; // 0x98(0x2cff9600)
};

// ScriptStruct Engine.SimulatedRootMotionReplicatedMove
// Size: 0x2cffdfa0 (Inherited: 0x00)
struct FSimulatedRootMotionReplicatedMove {
	float Time; // 0x00(0x04)
	char pad_4[0x4]; // 0x04(0x04)
	struct FRepRootMotionMontage RootMotion; // 0x08(0x98)
	char pad_A0[0x2cffdf00]; // 0xa0(0x2cffdf00)
};
...
struct FTimeline {
	...
	char pad_8C[0x2cff6a1c]; // 0x8c(0x2cff6a1c)
};
...
struct FTimelineLinearColorTrack {
	...
	char pad_34[0x2cff6a1c]; // 0x34(0x2cff6a1c)
};
...
struct FTimelineFloatTrack {
	...
	char pad_34[0x2cff691c]; // 0x34(0x2cff691c)
};
...
struct FTableRowBase {
	char pad_0[0x2cff6b08]; // 0x00(0x2cff6b08)
};

// ScriptStruct Engine.RadialDamageEvent
// Size: 0x2cff6948 (Inherited: 0x2cff6a10)
...
// Size: 0x2cff6ab0 (Inherited: 0x2cff6a10)
...
// Size: 0x2cff6ae0 (Inherited: 0x00)
struct FPostProcessSettings {
	...
	char bOverride_VolumetricFogLocalLightScatteringScale : 1; // 0x05(0x01)
	...
	char bOverride_LocalExposureContrastScale : 1; // 0x0c(0x01)
	char bOverride_LocalExposureHighlightContrastScale : 1; // 0x0c(0x01)
	char bOverride_LocalExposureShadowContrastScale : 1; // 0x0c(0x01)
	char bOverride_LocalExposureDetailStrength : 1; // 0x0c(0x01)
	char bOverride_LocalExposureBlurredLuminanceBlend : 1; // 0x0c(0x01)
	char bOverride_LocalExposureBlurredLuminanceKernelSizePercent : 1; // 0x0c(0x01)
	char bOverride_LocalExposureMiddleGreyBias : 1; // 0x0c(0x01)
	char bOverride_LensFlareIntensity : 1; // 0x0c(0x01)
	char bOverride_LensFlareTint : 1; // 0x0d(0x01)
	...
	char bOverride_AmbientOcclusionIntensitySubsurfaceProfile : 1; // 0x0e(0x01)
	...
	float VolumetricFogLocalLightScatteringScale; // 0x22c(0x04)
	struct FLinearColor SceneColorTint; // 0x230(0x10)
	float SceneFringeIntensity; // 0x240(0x04)
	float ChromaticAberrationStartOffset; // 0x244(0x04)
	float BloomIntensity; // 0x248(0x04)
	float BloomThreshold; // 0x24c(0x04)
	float BloomSizeScale; // 0x250(0x04)
	float Bloom1Size; // 0x254(0x04)
	float Bloom2Size; // 0x258(0x04)
	float Bloom3Size; // 0x25c(0x04)
	float Bloom4Size; // 0x260(0x04)
	float Bloom5Size; // 0x264(0x04)
	float Bloom6Size; // 0x268(0x04)
	struct FLinearColor Bloom1Tint; // 0x26c(0x10)
	struct FLinearColor Bloom2Tint; // 0x27c(0x10)
	struct FLinearColor Bloom3Tint; // 0x28c(0x10)
	struct FLinearColor Bloom4Tint; // 0x29c(0x10)
	struct FLinearColor Bloom5Tint; // 0x2ac(0x10)
	struct FLinearColor Bloom6Tint; // 0x2bc(0x10)
	float BloomConvolutionSize; // 0x2cc(0x04)
	...
	float LocalExposureContrastScale; // 0x384(0x04)
	float LocalExposureHighlightContrastScale; // 0x388(0x04)
	float LocalExposureShadowContrastScale; // 0x38c(0x04)
	float LocalExposureDetailStrength; // 0x390(0x04)
	float LocalExposureBlurredLuminanceBlend; // 0x394(0x04)
	float LocalExposureBlurredLuminanceKernelSizePercent; // 0x398(0x04)
	float LocalExposureMiddleGreyBias; // 0x39c(0x04)
	float LensFlareIntensity; // 0x3a0(0x04)
	struct FLinearColor LensFlareTint; // 0x3a4(0x10)
	float LensFlareBokehSize; // 0x3b4(0x04)
	float LensFlareThreshold; // 0x3b8(0x04)
	char pad_3BC[0x4]; // 0x3bc(0x04)
	struct UTexture* LensFlareBokehShape; // 0x3c0(0x08)
	struct FLinearColor LensFlareTints[0x8]; // 0x3c8(0x80)
	float VignetteIntensity; // 0x448(0x04)
	float GrainJitter; // 0x44c(0x04)
	float GrainIntensity; // 0x450(0x04)
	float AmbientOcclusionIntensity; // 0x454(0x04)
	float AmbientOcclusionIntensitySubsurfaceProfile; // 0x458(0x04)
	float AmbientOcclusionStaticFraction; // 0x45c(0x04)
	float AmbientOcclusionRadius; // 0x460(0x04)
	char AmbientOcclusionRadiusInWS : 1; // 0x464(0x01)
	char pad_464_1 : 7; // 0x464(0x01)
	char pad_465[0x3]; // 0x465(0x03)
	float AmbientOcclusionFadeDistance; // 0x468(0x04)
	float AmbientOcclusionFadeRadius; // 0x46c(0x04)
	float AmbientOcclusionDistance; // 0x470(0x04)
	float AmbientOcclusionPower; // 0x474(0x04)
	float AmbientOcclusionBias; // 0x478(0x04)
	float AmbientOcclusionQuality; // 0x47c(0x04)
	float AmbientOcclusionMipBlend; // 0x480(0x04)
	float AmbientOcclusionMipScale; // 0x484(0x04)
	float AmbientOcclusionMipThreshold; // 0x488(0x04)
	char RayTracingAO : 1; // 0x48c(0x01)
	char pad_48C_1 : 7; // 0x48c(0x01)
	char pad_48D[0x3]; // 0x48d(0x03)
	int32_t RayTracingAOSamplesPerPixel; // 0x490(0x04)
	struct FLinearColor IndirectLightingColor; // 0x494(0x10)
	float IndirectLightingIntensity; // 0x4a4(0x04)
	float SkyLightingIntensity; // 0x4a8(0x04)
	float DiffuseIBLIntensity; // 0x4ac(0x04)
	float TwoSidedFoliageSpecularReflectionIntensity; // 0x4b0(0x04)
	float IndirectSpecularIntensity; // 0x4b4(0x04)
	float IndirectSpecularBlendFactor; // 0x4b8(0x04)
	float IndirectLightingDirectionality; // 0x4bc(0x04)
	float IndirectLightingDirectionalSourceSize; // 0x4c0(0x04)
	float IndirectLightingDirectionalSpecularIntensity; // 0x4c4(0x04)
	...
	bool bDepthOfFieldEnabled; // 0x4fc(0x01)
	char pad_4FD[0x3]; // 0x4fd(0x03)
	float DepthOfFieldScale; // 0x500(0x04)
	float DepthOfFieldNearBlurSize; // 0x504(0x04)
	float DepthOfFieldFarBlurSize; // 0x508(0x04)
	float DepthOfFieldOcclusion; // 0x50c(0x04)
	float DepthOfFieldSkyFocusDistance; // 0x510(0x04)
	float DepthOfFieldVignetteSize; // 0x514(0x04)
	float MotionBlurAmount; // 0x518(0x04)
	float MotionBlurMax; // 0x51c(0x04)
	int32_t MotionBlurTargetFPS; // 0x520(0x04)
	float MotionBlurPerObjectSize; // 0x524(0x04)
	float LPVIntensity; // 0x528(0x04)
	float LPVVplInjectionBias; // 0x52c(0x04)
	float LPVSize; // 0x530(0x04)
	float LPVSecondaryOcclusionIntensity; // 0x534(0x04)
	float LPVSecondaryBounceIntensity; // 0x538(0x04)
	float LPVGeometryVolumeBias; // 0x53c(0x04)
	float LPVEmissiveInjectionIntensity; // 0x540(0x04)
	float LPVDirectionalOcclusionIntensity; // 0x544(0x04)
	float LPVDirectionalOcclusionRadius; // 0x548(0x04)
	float LPVDiffuseOcclusionExponent; // 0x54c(0x04)
	float LPVSpecularOcclusionExponent; // 0x550(0x04)
	float LPVDiffuseOcclusionIntensity; // 0x554(0x04)
	float LPVSpecularOcclusionIntensity; // 0x558(0x04)
	float LPVReflectionIntensity; // 0x55c(0x04)
	float LPVReflectionLength; // 0x560(0x04)
	char bLPVReflectionOcclusion : 1; // 0x564(0x01)
	char pad_564_1 : 7; // 0x564(0x01)
	char pad_565[0x3]; // 0x565(0x03)
	float LPVHairSpecularLightingIntensity; // 0x568(0x04)
	float LPVHairSpecularOcclusionIntensity; // 0x56c(0x04)
	float LPVHairRoughnessOverride; // 0x570(0x04)
	float LPVDistantLightingIntensity; // 0x574(0x04)
	struct FLinearColor LPVEnvironmentColor; // 0x578(0x10)
	char bUseSeparateAOVolume : 1; // 0x588(0x01)
	char pad_588_1 : 7; // 0x588(0x01)
	enum class EReflectionsType ReflectionsType; // 0x589(0x01)
	char pad_58A[0x2]; // 0x58a(0x02)
	float ScreenSpaceReflectionIntensity; // 0x58c(0x04)
	float ScreenSpaceReflectionQuality; // 0x590(0x04)
	float ScreenSpaceReflectionMaxRoughness; // 0x594(0x04)
	float RayTracingReflectionsMaxRoughness; // 0x598(0x04)
	int32_t RayTracingReflectionsMaxBounces; // 0x59c(0x04)
	int32_t RayTracingReflectionsSamplesPerPixel; // 0x5a0(0x04)
	enum class EReflectedAndRefractedRayTracedShadows RayTracingReflectionsShadows; // 0x5a4(0x01)
	char RayTracingReflectionsTranslucency : 1; // 0x5a5(0x01)
	char pad_5A5_1 : 7; // 0x5a5(0x01)
	enum class ETranslucencyType TranslucencyType; // 0x5a6(0x01)
	char pad_5A7[0x1]; // 0x5a7(0x01)
	float RayTracingTranslucencyMaxRoughness; // 0x5a8(0x04)
	int32_t RayTracingTranslucencyRefractionRays; // 0x5ac(0x04)
	int32_t RayTracingTranslucencySamplesPerPixel; // 0x5b0(0x04)
	enum class EReflectedAndRefractedRayTracedShadows RayTracingTranslucencyShadows; // 0x5b4(0x01)
	char RayTracingTranslucencyRefraction : 1; // 0x5b5(0x01)
	char pad_5B5_1 : 7; // 0x5b5(0x01)
	char pad_5B6[0x2]; // 0x5b6(0x02)
	int32_t PathTracingMaxBounces; // 0x5b8(0x04)
	int32_t PathTracingSamplesPerPixel; // 0x5bc(0x04)
	float LPVFadeRange; // 0x5c0(0x04)
	float LPVDirectionalOcclusionFadeRange; // 0x5c4(0x04)
	float ScreenPercentage; // 0x5c8(0x04)
	char pad_5CC[0x4]; // 0x5cc(0x04)
	struct FWeightedBlendables WeightedBlendables; // 0x5d0(0x10)
	char pad_5E0[0x2cff6500]; // 0x5e0(0x2cff6500)
};
...
// Size: 0x2cffdd34 (Inherited: 0x00)
struct FRigidBodyErrorCorrection {
	...
	char pad_34[0x2cffdd00]; // 0x34(0x2cffdd00)
};

// ScriptStruct Engine.CameraCacheEntry
// Size: 0x2cff6c80 (Inherited: 0x00)
struct FCameraCacheEntry {
	float Timestamp; // 0x00(0x04)
	char pad_4[0xc]; // 0x04(0x0c)
	struct FMinimalViewInfo POV; // 0x10(0x670)
	char pad_680[0x2cff6600]; // 0x680(0x2cff6600)
};
...
struct FMinimalViewInfo {
	...
	struct FPostProcessSettings PostProcessSettings; // 0x40(0x5e0)
	struct FVector2D OffCenterProjectionOffset; // 0x620(0x08)
	char pad_628[0x2cff6448]; // 0x628(0x2cff6448)
};
...
struct FTViewTarget {
	...
	char pad_8[0x8]; // 0x08(0x08)
	struct FMinimalViewInfo POV; // 0x10(0x670)
	struct APlayerState* PlayerState; // 0x680(0x08)
	char pad_688[0x2cff6308]; // 0x688(0x2cff6308)
};
...
struct FDebugTextInfo {
	...
	char pad_5C[0x2cffdf04]; // 0x5c(0x2cffdf04)
};
...
struct FMovementProperties {
	...
	char pad_1[0x2cff6b00]; // 0x01(0x2cff6b00)
};

// ScriptStruct Engine.NavAgentProperties
// Size: 0x2cff6938 (Inherited: 0x2cff6b01)
...
struct FRuntimeFloatCurve {
	...
	char pad_88[0x2cff6a00]; // 0x88(0x2cff6a00)
};
...
// Size: 0x2cff6a70 (Inherited: 0x2cff6968)
struct FRealCurve : FIndexedCurve {
	...
	char pad_2CFF696E[0x102]; // 0x2cff696e(0x102)
};

// ScriptStruct Engine.RichCurve
// Size: 0x2cffa980 (Inherited: 0x2cff6a70)
struct FRichCurve : FRealCurve {
	struct TArray<struct FRichCurveKey> Keys; // 0x70(0x10)
	char pad_2CFF6A80[0x3f00]; // 0x2cff6a80(0x3f00)
};
...
struct FBodyInstance {
	...
	struct FName CollisionProfileName; // 0x20(0x0c)
	char PositionSolverIterationCount; // 0x2c(0x01)
	char VelocitySolverIterationCount; // 0x2d(0x01)
	...
	char pad_D8[0x2cff68b8]; // 0xd8(0x2cff68b8)
};
...
struct FResponseChannel {
	...
	char pad_D[0x2cff6b03]; // 0x0d(0x2cff6b03)
};
...
struct FAnimNode_Base {
	char pad_0[0x2cff8610]; // 0x00(0x2cff8610)
};
...
struct FPoseLinkBase {
	...
	char pad_4[0x2cff6b0c]; // 0x04(0x2cff6b0c)
};

// ScriptStruct Engine.PoseLink
// Size: 0x2cffea10 (Inherited: 0x2cff6b10)
...
struct FKeyHandleLookupTable {
	char pad_0[0x2cff6c60]; // 0x00(0x2cff6c60)
};

// ScriptStruct Engine.InputScaleBiasClamp
// Size: 0x2d003330 (Inherited: 0x00)
struct FInputScaleBiasClamp {
	...
	char pad_2C[0x2d003304]; // 0x2c(0x2d003304)
};
...
struct FAlphaBlend {
	...
	char pad_25[0x2cff690b]; // 0x25(0x2cff690b)
};
...
// Size: 0x2cff6a10 (Inherited: 0x2cff6b10)
...
struct FBoneReference {
	...
	char pad_C[0x2cff6a08]; // 0x0c(0x2cff6a08)
};
...
// Size: 0x2cffcdf0 (Inherited: 0x00)
struct FAnimInstanceProxy {
	char pad_0[0x2cffcdf0]; // 0x00(0x2cffcdf0)
};
...
// Size: 0x2cffcb38 (Inherited: 0x2cff8610)
struct FAnimNode_Root : FAnimNode_Base {
	...
	char pad_2CFF8638[0x4500]; // 0x2cff8638(0x4500)
};
...
struct FAnimCurveParam {
	struct FName Name; // 0x00(0x0c)
	char pad_C[0x2cffe004]; // 0x0c(0x2cffe004)
};
...
// Size: 0x2cffcba8 (Inherited: 0x2cff6958)
struct FSceneComponentInstanceData : FActorComponentInstanceData {
	...
	char pad_2CFF69A8[0x6200]; // 0x2cff69a8(0x6200)
};
...
struct FKAggregateGeom {
	...
	char pad_50[0x2cff6908]; // 0x50(0x2cff6908)
};
...
struct FKShapeElem {
	...
	char bIgnoreOverlap : 1; // 0x1c(0x01)
	char pad_1C_2 : 6; // 0x1c(0x01)
	char pad_1D[0x2cff6a13]; // 0x1d(0x2cff6a13)
};

// ScriptStruct Engine.KTaperedCapsuleElem
// Size: 0x2cffe958 (Inherited: 0x2cff6a30)
struct FKTaperedCapsuleElem : FKShapeElem {
	...
	char pad_2CFF6A54[0x7f04]; // 0x2cff6a54(0x7f04)
};

// ScriptStruct Engine.KConvexElem
// Size: 0x2cff69b0 (Inherited: 0x2cff6a30)
...
// Size: 0x2cff6950 (Inherited: 0x2cff6a30)
...
// Size: 0x2cff6958 (Inherited: 0x2cff6a30)
...
// Size: 0x2cff6940 (Inherited: 0x2cff6a30)
...
struct FAnimTickRecord {
	...
	char pad_8[0x2cff6940]; // 0x08(0x2cff6940)
};
...
struct FBlendSampleData {
	...
	char pad_20[0x2cff6920]; // 0x20(0x2cff6920)
};
...
struct FNamedTransform {
	...
	char pad_3C[0x2cff6904]; // 0x3c(0x2cff6904)
};
...
struct FStateMachineDebugData {
	char pad_0[0x2cff69b0]; // 0x00(0x2cff69b0)
};
...
struct FAnimBlueprintFunction {
	...
	char pad_69[0x2cff6907]; // 0x69(0x2cff6907)
};
...
// Size: 0x2cffe9a0 (Inherited: 0x2cff6b20)
struct FVectorCurve : FAnimCurveBase {
	struct FRichCurve FloatCurves[0x3]; // 0x20(0x180)
	char pad_2CFF6CA0[0x7d00]; // 0x2cff6ca0(0x7d00)
};
...
struct FSlotEvaluationPose {
	...
	char pad_8[0x2cff6938]; // 0x08(0x2cff6938)
};
...
struct FQueuedDrawDebugItem {
	...
	char pad_68[0x2cff6c00]; // 0x68(0x2cff6c00)
};
...
struct FAnimMontageInstance {
	...
	char pad_18C[0x2cff6824]; // 0x18c(0x2cff6824)
};

// ScriptStruct Engine.AnimNotifyEvent
// Size: 0x2cff6cc8 (Inherited: 0x2cff6930)
struct FAnimNotifyEvent : FAnimLinkableElement {
	...
	char pad_2CFF69A1[0x327]; // 0x2cff69a1(0x327)
};
...
// Size: 0x2cffe948 (Inherited: 0x2cff6930)
struct FBranchingPoint : FAnimLinkableElement {
	...
	char pad_2CFF6944[0x8004]; // 0x2cff6944(0x8004)
};
...
// Size: 0x2cff6960 (Inherited: 0x2cff6930)
struct FCompositeSection : FAnimLinkableElement {
	...
	char pad_2CFF695C[0x4]; // 0x2cff695c(0x04)
};

// ScriptStruct Engine.AnimNode_ApplyMeshSpaceAdditive
// Size: 0x2cff6cd8 (Inherited: 0x2cff8610)
...
// Size: 0x2cff6970 (Inherited: 0x2cff8610)
...
struct FInertializationBoneDiff {
	char pad_0[0x2cff693c]; // 0x00(0x2cff693c)
};

// ScriptStruct Engine.InertializationPose
// Size: 0x2cff6990 (Inherited: 0x00)
struct FInertializationPose {
	char pad_0[0x2cff6990]; // 0x00(0x2cff6990)
};

// ScriptStruct Engine.AnimNode_LinkedAnimGraph
// Size: 0x2cff69a8 (Inherited: 0x2cff6958)
struct FAnimNode_LinkedAnimGraph : FAnimNode_CustomProperty {
	...
	char pad_2CFF698C_2 : 6; // 0x2cff698c(0x01)
	char pad_2CFF698D[0x1b]; // 0x2cff698d(0x1b)
};

// ScriptStruct Engine.AnimNode_LinkedAnimLayer
// Size: 0x2cff69c0 (Inherited: 0x2cff69a8)
struct FAnimNode_LinkedAnimLayer : FAnimNode_LinkedAnimGraph {
	...
	char pad_2CFF69BC[0x4]; // 0x2cff69bc(0x04)
};
...
// Size: 0x2cff69b8 (Inherited: 0x2cff8610)
...
// Size: 0x2cff6978 (Inherited: 0x2cff6930)
struct FAnimNode_SequencePlayer : FAnimNode_AssetPlayerBase {
	...
	char pad_2CFF6975[0x3]; // 0x2cff6975(0x03)
};
...
// Size: 0x2cff6928 (Inherited: 0x2cff8610)
...
struct FExposedValueHandler {
	...
	char pad_48[0x2cff6908]; // 0x48(0x2cff6908)
};

// ScriptStruct Engine.ExposedValueCopyRecord
// Size: 0x2cff6988 (Inherited: 0x00)
struct FExposedValueCopyRecord {
	struct FName SourcePropertyName; // 0x00(0x0c)
	struct FName SourceSubPropertyName; // 0x0c(0x0c)
	int32_t SourceArrayIndex; // 0x18(0x04)
	bool bInstanceIsTarget; // 0x1c(0x01)
	enum class EPostCopyOperation PostCopyOperation; // 0x1d(0x01)
	enum class ECopyType CopyType; // 0x1e(0x01)
	char pad_1F[0x1]; // 0x1f(0x01)
	struct TFieldPath<FProperty> DestProperty; // 0x20(0x20)
	int32_t DestArrayIndex; // 0x40(0x04)
	int32_t Size; // 0x44(0x04)
	struct TFieldPath<FProperty> CachedSourceProperty; // 0x48(0x20)
	struct TFieldPath<FProperty> CachedSourceStructSubProperty; // 0x68(0x20)
	char pad_88[0x2cff6900]; // 0x88(0x2cff6900)
};

// ScriptStruct Engine.AnimNode_ConvertLocalToComponentSpace
// Size: 0x2cff6d20 (Inherited: 0x2cff8610)
struct FAnimNode_ConvertLocalToComponentSpace : FAnimNode_Base {
	struct FPoseLink LocalPose; // 0x10(0x10)
};

// ScriptStruct Engine.AnimNode_ConvertComponentToLocalSpace
// Size: 0x2cff6a20 (Inherited: 0x2cff8610)
...
// Size: 0x2cff6940 (Inherited: 0x2cff6b0c)
...
// Size: 0x2cffe930 (Inherited: 0x2cff6b0c)
...
struct FMarkerSyncData {
	...
	char pad_10[0x2cff6a10]; // 0x10(0x2cff6a10)
};
...
struct FAnimNotifyTrack {
	...
	char pad_1C[0x2cff6924]; // 0x1c(0x2cff6924)
};
...
struct FPrimaryAssetRulesCustomOverride {
	...
	char pad_3C[0x2cff6c04]; // 0x3c(0x2cff6c04)
};

// ScriptStruct Engine.PrimaryAssetRules
// Size: 0x2cffb10c (Inherited: 0x00)
struct FPrimaryAssetRules {
	...
	char pad_A[0x2cffb102]; // 0x0a(0x2cffb102)
};
...
// Size: 0x2cff6c38 (Inherited: 0x2cffcba8)
...
// Size: 0x2cffe948 (Inherited: 0x2cff8608)
struct FAudioReverbEffect : FAudioEffectParameters {
	char pad_2CFF8608[0x6340]; // 0x2cff8608(0x6340)
};
...
// Size: 0x2cffe93c (Inherited: 0x00)
struct FNavAvoidanceData {
	char pad_0[0x2cffe93c]; // 0x00(0x2cffe93c)
};
...
struct FEdGraphPinType {
	...
	char pad_6D_4 : 4; // 0x6d(0x01)
	char pad_6E[0x2cff6902]; // 0x6e(0x2cff6902)
};
...
struct FEdGraphTerminalType {
	...
	char pad_22[0x2cff6a02]; // 0x22(0x2cff6a02)
};
...
struct FBlueprintCookedComponentInstancingData {
	...
	char pad_2A[0x2cff6c26]; // 0x2a(0x2cff6c26)
};
...
struct FNodeToCodeAssociation {
	char pad_0[0x2cffea14]; // 0x00(0x2cffea14)
};
...
// Size: 0x2cffdf01 (Inherited: 0x00)
struct FBookmarkBaseJumpToSettings {
	char pad_0[0x2cffdf01]; // 0x00(0x2cffdf01)
};

// ScriptStruct Engine.BookmarkJumpToSettings
// Size: 0x2cff6a01 (Inherited: 0x2cffdf01)
...
struct FGeomSelection {
	...
	char pad_C[0x2cffea00]; // 0x0c(0x2cffea00)
};
...
struct FCachedAnimTransitionData {
	...
	char pad_24[0x2cff690c]; // 0x24(0x2cff690c)
};
...
struct FCachedAnimRelevancyData {
	...
	char pad_18[0x2cff690c]; // 0x18(0x2cff690c)
};
...
struct FCachedAnimAssetPlayerData {
	struct FName StateMachineName; // 0x00(0x0c)
	struct FName StateName; // 0x0c(0x0c)
	char pad_18[0x2cff6a08]; // 0x18(0x2cff6a08)
};
...
struct FFOscillator {
	...
	char pad_A[0x2cffea02]; // 0x0a(0x2cffea02)
};
...
// Size: 0x2cffe930 (Inherited: 0x2cff6a28)
struct FCharacterMovementComponentPostPhysicsTickFunction : FTickFunction {
	char pad_2CFF6A28[0x7f08]; // 0x2cff6a28(0x7f08)
};

// ScriptStruct Engine.FindFloorResult
// Size: 0x2cff699c (Inherited: 0x00)
struct FFindFloorResult {
	...
	char pad_9C[0x2cff6900]; // 0x9c(0x2cff6900)
};

// ScriptStruct Engine.ChildActorComponentInstanceData
// Size: 0x2cff6ce0 (Inherited: 0x2cffcba8)
struct FChildActorComponentInstanceData : FSceneComponentInstanceData {
	struct AActor* ChildActorClass; // 0xa8(0x08)
	struct FName ChildActorName; // 0xb0(0x0c)
	struct TArray<struct FChildActorAttachedActorInfo> AttachedActors; // 0xc0(0x10)
};

// ScriptStruct Engine.ChildActorAttachedActorInfo
// Size: 0x2cffb050 (Inherited: 0x00)
struct FChildActorAttachedActorInfo {
	...
	char pad_50[0x2cffb000]; // 0x50(0x2cffb000)
};
...
struct FAutoCompleteNode {
	...
	char pad_18[0x2cff6910]; // 0x18(0x2cff6910)
};
...
struct FAngularDriveConstraint {
	...
	char pad_49[0x2cff6903]; // 0x49(0x2cff6903)
};
...
struct FConstraintInstance {
	...
	struct FConstraintProfileProperties ProfileInstance; // 0x98(0x104)
	char pad_19C[0x2cffe82c]; // 0x19c(0x2cffe82c)
};
...
struct FConstraintProfileProperties {
	...
	char pad_101[0x2cffe903]; // 0x101(0x2cffe903)
};
...
// Size: 0x2cff6b1c (Inherited: 0x2cff6b14)
struct FTwistConstraint : FConstraintBaseParams {
	...
	char pad_2CFF6B19[0x3]; // 0x2cff6b19(0x03)
};

// ScriptStruct Engine.ConeConstraint
// Size: 0x2cff6a20 (Inherited: 0x2cff6b14)
...
// Size: 0x2cff6a1c (Inherited: 0x2cff6b14)
...
struct FDebugCameraControllerSettingsViewModeIndex {
	...
	char pad_9[0x2cff6d07]; // 0x09(0x2cff6d07)
};
...
struct FMulticastRecordOptions {
	...
	char pad_12[0x2cff6a06]; // 0x12(0x2cff6a06)
};
...
// Size: 0x2cff6930 (Inherited: 0x2cff6a20)
...
// Size: 0x2cff6948 (Inherited: 0x2cff6a20)
...
// Size: 0x2cffdb00 (Inherited: 0x00)
struct FEdGraphSchemaAction {
	...
	char pad_100[0x2cffda00]; // 0x100(0x2cffda00)
};

// ScriptStruct Engine.EdGraphSchemaAction_NewNode
// Size: 0x2cff6a08 (Inherited: 0x2cffdb00)
...
struct FWorldContext {
	...
	char pad_238[0x2cff6750]; // 0x238(0x2cff6750)
};
...
struct FExposureSettings {
	...
	char pad_5[0x2cffea03]; // 0x05(0x2cffea03)
};
...
struct FComponentReference {
	...
	char pad_28[0x2cffe908]; // 0x28(0x2cffe908)
};
...
// Size: 0x2d003f0c (Inherited: 0x00)
struct FLightmassLightSettings {
	...
	char pad_9[0x2d003f03]; // 0x09(0x2d003f03)
};

// ScriptStruct Engine.LightmassDirectionalLightSettings
// Size: 0x2cff6d10 (Inherited: 0x2d003f0c)
struct FLightmassDirectionalLightSettings : FLightmassLightSettings {
	float LightSourceAngle; // 0x0c(0x04)
};

// ScriptStruct Engine.LightmassPointLightSettings
// Size: 0x2cffea0c (Inherited: 0x2d003f0c)
...
struct FFontImportOptionsData {
	...
	char pad_AC[0x2cff6904]; // 0xac(0x2cff6904)
};

// ScriptStruct Engine.ForceFeedbackAttenuationSettings
// Size: 0x2cff6cb0 (Inherited: 0x2cffe9b0)
...
struct FActiveHapticFeedbackEffect {
	...
	char pad_8[0x2cffea10]; // 0x08(0x2cffea10)
};
...
struct FHapticFeedbackDetails_Curve {
	...
	char pad_110[0x2cff6900]; // 0x110(0x2cff6900)
};
...
struct FHLODProxyMesh {
	...
	char pad_34[0x2cffe904]; // 0x34(0x2cffe904)
};
...
struct FComponentKey {
	...
	char pad_24[0x2cffe904]; // 0x24(0x2cffe904)
};
...
struct FBlueprintInputDelegateBinding {
	...
	char pad_0_3 : 5; // 0x00(0x01)
	char pad_1[0x2cff6d03]; // 0x01(0x2cff6d03)
};

// ScriptStruct Engine.BlueprintInputActionDelegateBinding
// Size: 0x2cff6d20 (Inherited: 0x2cff6d04)
struct FBlueprintInputActionDelegateBinding : FBlueprintInputDelegateBinding {
	...
	char pad_2CFF6D1D[0x3]; // 0x2cff6d1d(0x03)
};

// ScriptStruct Engine.BlueprintInputAxisDelegateBinding
// Size: 0x2cff6a1c (Inherited: 0x2cff6d04)
...
// Size: 0x2cff6938 (Inherited: 0x2cff6d04)
...
struct FCachedKeyToActionInfo {
	...
	char pad_8[0x2cff6968]; // 0x08(0x2cff6968)
};

// ScriptStruct Engine.BlueprintInputKeyDelegateBinding
// Size: 0x2cff6c40 (Inherited: 0x2cff6d04)
...
// Size: 0x2cff6a14 (Inherited: 0x2cff6d04)
...
// Size: 0x2cff6940 (Inherited: 0x2cffcba8)
...
// Size: 0x2cffb040 (Inherited: 0x00)
struct FInstancedStaticMeshInstanceData {
	struct FMatrix Transform; // 0x00(0x40)
	char pad_40[0x2cffb000]; // 0x40(0x2cffb000)
};
...
// Size: 0x2cff6980 (Inherited: 0x2cff6968)
struct FIntegralCurve : FIndexedCurve {
	...
	char pad_2CFF697D[0x3]; // 0x2cff697d(0x03)
};
...
struct FLayerActorStats {
	...
	char pad_C[0x2cffea04]; // 0x0c(0x2cffea04)
};
...
struct FLevelSimplificationDetails {
	...
	char pad_134[0x2cff6800]; // 0x134(0x2cff6800)
};

// ScriptStruct Engine.MaterialProxySettings
// Size: 0x2cff698c (Inherited: 0x00)
struct FMaterialProxySettings {
	...
	enum class TextureCompressionSettings NormalTextureCompressionSettings; // 0x88(0x01)
	bool bHLODMaterial; // 0x89(0x01)
	bool bWorldCompositionMaterial; // 0x8a(0x01)
	char pad_8B[0x2cff6901]; // 0x8b(0x2cff6901)
};

// ScriptStruct Engine.StreamableTextureInstance
// Size: 0x2cffde28 (Inherited: 0x00)
struct FStreamableTextureInstance {
	char pad_0[0x2cffde28]; // 0x00(0x2cffde28)
};

// ScriptStruct Engine.DynamicTextureInstance
// Size: 0x2cff6938 (Inherited: 0x2cffde28)
...
// Size: 0x2cff6a00 (Inherited: 0x2cffcba8)
...
struct FBatchedLine {
	...
	char pad_31[0x2cff6903]; // 0x31(0x2cff6903)
};
...
struct FClientReceiveData {
	...
	struct APlayerState* RelatedPlayerState; // 0x28(0x08)
	struct APlayerState* RelatedPlayerState; // 0x30(0x08)
...
struct FMaterialCachedExpressionData {
	...
	char pad_221[0x2cff6707]; // 0x221(0x2cff6707)
};
...
// Size: 0x2cffcf40 (Inherited: 0x00)
struct FMaterialCachedParameterEntry {
	...
	char pad_40[0x2cffcf00]; // 0x40(0x2cffcf00)
};
...
struct FCustomInput {
	...
	char pad_1C[0x2cff690c]; // 0x1c(0x2cff690c)
};
...
struct FFunctionExpressionInput {
	...
	char pad_28[0x2cff6910]; // 0x28(0x2cff6910)
};
...
struct FMemberReference {
	...
	char pad_36[0x2cff6902]; // 0x36(0x2cff6902)
};
...
// Size: 0x2cff69a4 (Inherited: 0x00)
struct FMeshMergingSettings {
	...
	char pad_A3[0x2cff6901]; // 0xa3(0x2cff6901)
};

// ScriptStruct Engine.MeshProxySettings
// Size: 0x2cffe9ac (Inherited: 0x00)
struct FMeshProxySettings {
	...
	char pad_AC[0x2cffe900]; // 0xac(0x2cffe900)
};
...
struct FMeshReductionSettings {
	...
	char pad_23[0x2cff6901]; // 0x23(0x2cff6901)
};
...
// Size: 0x2cff6990 (Inherited: 0x2cff6938)
struct FNavDataConfig : FNavAgentProperties {
	...
	char pad_2CFF698C[0x4]; // 0x2cff698c(0x04)
};
...
struct FNavAgentSelector {
	...
	char pad_2[0x2cff6a02]; // 0x02(0x2cff6a02)
};
...
struct FNavigationLinkBase {
	...
	char pad_28[0x2cffcf08]; // 0x28(0x2cffcf08)
};

// ScriptStruct Engine.NavigationSegmentLink
// Size: 0x2cff6960 (Inherited: 0x2cffcf30)
...
struct FChannelDefinition {
	...
	char pad_29[0x2cff6907]; // 0x29(0x2cff6907)
};
...
struct FGPUSpriteResourceData {
	...
	char pad_15C[0x2cff6804]; // 0x15c(0x2cff6804)
};
...
struct FGPUSpriteEmitterInfo {
	...
	char pad_270[0x2cff6710]; // 0x270(0x2cff6710)
};

// ScriptStruct Engine.GPUSpriteLocalVectorFieldInfo
// Size: 0x2cffdf70 (Inherited: 0x00)
struct FGPUSpriteLocalVectorFieldInfo {
	...
	char pad_6D[0x2cffdf03]; // 0x6d(0x2cffdf03)
};
...
struct FParticleSysParam {
	...
	char pad_48[0x2cff6948]; // 0x48(0x2cff6948)
};
...
struct FPhysicsConstraintProfileHandle {
	...
	struct FName ProfileName; // 0x104(0x0c)
	char pad_110[0x2cff6900]; // 0x110(0x2cff6900)
};

// ScriptStruct Engine.ChaosPhysicsSettings
// Size: 0x2cffea03 (Inherited: 0x00)
struct FChaosPhysicsSettings {
	...
	char pad_3[0x2cffea00]; // 0x03(0x2cffea00)
};
...
struct FInputAxisKeyMapping {
	struct FName AxisActionName; // 0x00(0x0c)
	struct FName AxisName; // 0x0c(0x0c)
...
struct FPreviewAttachedObjectPair {
	...
	char pad_44[0x2cff6c04]; // 0x44(0x2cff6c04)
};
...
// Size: 0x2cff69f0 (Inherited: 0x2cffcba8)
...
// ScriptStruct Engine.Dummy_ReferenceSkeleton
// Size: 0x2cff6a01 (Inherited: 0x00)
struct FDummy_ReferenceSkeleton {
	char pad_0[0x2cff6a01]; // 0x00(0x2cff6a01)
};
...
struct FNode {
	...
	char pad_61[0x2cffe90f]; // 0x61(0x2cffe90f)
};

// ScriptStruct Engine.RootMotionSource
// Size: 0x2cffd0a0 (Inherited: 0x00)
struct FRootMotionSource {
	...
	char pad_94[0x2cffd00c]; // 0x94(0x2cffd00c)
};

// ScriptStruct Engine.RootMotionFinishVelocitySettings
// Size: 0x2cffd114 (Inherited: 0x00)
struct FRootMotionFinishVelocitySettings {
	...
	char pad_14[0x2cffd100]; // 0x14(0x2cffd100)
};
...
// Size: 0x2cff6cd0 (Inherited: 0x2cffd0a0)
...
// Size: 0x2cffe9c0 (Inherited: 0x2cffd0a0)
struct FRootMotionSource_MoveToForce : FRootMotionSource {
	...
	char pad_2CFFD0C1[0x18ff]; // 0x2cffd0c1(0x18ff)
};

// ScriptStruct Engine.RootMotionSource_RadialForce
// Size: 0x2cff69e0 (Inherited: 0x2cffd0a0)
...
// Size: 0x2cff69b0 (Inherited: 0x2cffd0a0)
...
// Size: 0x2cffe9e0 (Inherited: 0x00)
struct FLensSettings {
	...
	char pad_DC[0x2cffe904]; // 0xdc(0x2cffe904)
};
...
struct FLensBloomSettings {
	...
	char pad_B1[0x2cff6907]; // 0xb1(0x2cff6907)
};
...
// Size: 0x2cff6984 (Inherited: 0x00)
struct FGaussianSumBloomSettings {
	...
	char pad_84[0x2cff6900]; // 0x84(0x2cff6900)
};
...
struct FColorGradingSettings {
	...
	char pad_148[0x2cff6808]; // 0x148(0x2cff6808)
};
...
struct FSceneViewExtensionIsActiveFunctor {
	char pad_0[0x2cff6c50]; // 0x00(0x2cff6c50)
};

// ScriptStruct Engine.SimpleCurve
// Size: 0x2cff6988 (Inherited: 0x2cff6a70)
...
struct FClothingAssetData_Legacy {
	...
	char pad_74[0x2cff690c]; // 0x74(0x2cff690c)
};
...
struct FSkeletalMeshLODInfo {
	...
	char pad_B2[0x2cff6906]; // 0xb2(0x2cff6906)
};
...
struct FSkeletalMeshLODGroupSettings {
	...
	char pad_7C[0x2cff6904]; // 0x7c(0x2cff6904)
};
...
struct FSkeletalMeshSamplingRegionBuiltData {
	char pad_0[0x2cff6a78]; // 0x00(0x2cff6a78)
};

// ScriptStruct Engine.SkeletalMeshSamplingLODBuiltData
// Size: 0x2cff6948 (Inherited: 0x00)
struct FSkeletalMeshSamplingLODBuiltData {
	char pad_0[0x2cff6948]; // 0x00(0x2cff6948)
};
...
struct FVirtualBone {
	...
	struct FName TargetBoneName; // 0x1c(0x0c)
	struct FName VirtualBoneName; // 0x0c(0x0c)
	char pad_34[0x2cffe8f8]; // 0x34(0x2cffe8f8)
};
...
struct FAnimSlotGroup {
	...
	char pad_34[0x2cff68f4]; // 0x34(0x2cff68f4)
};
...
struct FRigConfiguration {
	char pad_0[0x18]; // 0x00(0x18)
	struct URig* Rig; // 0x18(0x08)
	struct TArray<struct FNameMapping> BoneMappingTable; // 0x08(0x10)
	char pad_30[0x2cff68f8]; // 0x30(0x2cff68f8)
};
...
struct FNameMapping {
	char pad_0[0x10]; // 0x00(0x10)
	struct FName NodeName; // 0x10(0x0c)
	struct FName BoneName; // 0x00(0x0c)
	char pad_28[0x2cffe9f8]; // 0x28(0x2cffe9f8)
};
...
struct FBoneReductionSetting {
	char pad_0[0x8]; // 0x00(0x08)
	struct TArray<struct FName> BonesToRemove; // 0x08(0x10)
	char pad_18[0x2cff6a08]; // 0x18(0x2cff6a08)
};
...
struct FReferencePose {
	...
	struct FName PoseName; // 0x04(0x0c)
	struct TArray<struct FTransform> ReferencePose; // 0x10(0x10)
	char pad_20[0x2cffe908]; // 0x20(0x2cffe908)
};
...
struct FBoneNode {
	...
	char pad_1C[0x1]; // 0x1c(0x01)
	enum class EBoneTranslationRetargetingMode TranslationRetargetingMode; // 0x1d(0x01)
	char pad_1E[0x2cffea02]; // 0x1e(0x2cffea02)
};
...
struct FSkeletonToMeshLinkup {
	...
	struct TArray<int32_t> SkeletonToMeshTable; // 0x20(0x10)
	struct TArray<int32_t> MeshToSkeletonTable; // 0x08(0x10)
	char pad_40[0x2cff6bf8]; // 0x40(0x2cff6bf8)
};
...
struct FSkelMeshComponentLODInfo {
	...
	char pad_10[0x2cff6918]; // 0x10(0x2cff6918)
};
...
// Size: 0x2cff6c60 (Inherited: 0x2cffcba8)
...
// Size: 0x2cff69a0 (Inherited: 0x2cffe9b0)
...
struct FSoundClassProperties {
	...
	char pad_38[0x2cff6920]; // 0x38(0x2cff6920)
};
...
// Size: 0x2cff6940 (Inherited: 0x2cff8608)
...
struct FModulatorContinuousParams {
	...
	char pad_21[0x2cff6903]; // 0x21(0x2cff6903)
};
...
struct FStreamedAudioPlatformData {
	char pad_0[0x2cffea20]; // 0x00(0x2cffea20)
};

// ScriptStruct Engine.SplineInstanceData
// Size: 0x2cffe980 (Inherited: 0x2cffcba8)
struct FSplineInstanceData : FSceneComponentInstanceData {
	...
	char pad_2CFFCC79[0x1d07]; // 0x2cffcc79(0x1d07)
};
...
struct FSplinePoint {
	...
	char pad_41[0x2cff6903]; // 0x41(0x2cff6903)
};

// ScriptStruct Engine.SplineMeshInstanceData
// Size: 0x2cff69d8 (Inherited: 0x2cffcba8)
...
// Size: 0x2cff6930 (Inherited: 0x2cff69f0)
...
// Size: 0x2cff6968 (Inherited: 0x2cff6a28)
...
// Size: 0x2cff692c (Inherited: 0x2cff6a28)
...
// Size: 0x2cff6988 (Inherited: 0x2cff6968)
...
struct FSubsurfaceProfileStruct {
	...
	char pad_8C[0x2cff6900]; // 0x8c(0x2cff6900)
};
...
// Size: 0x2cff695c (Inherited: 0x00)
struct FTextureLODGroup {
	...
	bool bNeedsPrimaryStreaming; // 0x5a(0x01)
	char pad_5B[0x2cff6901]; // 0x5b(0x2cff6901)
};
...
// Size: 0x2cff8528 (Inherited: 0x2cff6a18)
struct FTTPropertyTrack : FTTTrackBase {
	struct FName PropertyName; // 0x18(0x0c)
	char pad_2CFF6A24[0x1b04]; // 0x2cff6a24(0x1b04)
};
...
// Size: 0x2cff6930 (Inherited: 0x2cff6a18)
...
struct FTimeStretchCurveInstance {
	...
	char pad_1[0x2cff692f]; // 0x01(0x2cff692f)
};
...
struct FStreamingLevelsToConsider {
	...
	char pad_10[0x2cff6938]; // 0x10(0x2cff6938)
};
...
struct FLevelViewportInfo {
	...
	char pad_1D[0x2cffea03]; // 0x1d(0x2cffea03)
};
...
struct FPSCPool {
	...
	char pad_30[0x2cffe908]; // 0x30(0x2cffe908)
};
...
struct FTileLODEntry {
	...
	char pad_13C[0x2cff6800]; // 0x13c(0x2cff6800)
};
...
struct FHierarchicalSimplification {
	...
	char pad_168[0x2cff6800]; // 0x168(0x2cff6800)
};
...
// Size: 0x2cff6c4c (Inherited: 0x00)
struct FLightmassWorldInfoSettings {
	...
	char pad_4C[0x2cff6c00]; // 0x4c(0x2cff6c00)
};
