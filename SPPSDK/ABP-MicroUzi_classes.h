...
struct UABP-MicroUzi_C : UBravoHotelAnimInstanceWeapon {
	...
	void AnimGraph(struct FPoseLink& AnimGraph); // Function ABP-MicroUzi.ABP-MicroUzi_C.AnimGraph // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x2bad3b0
	void ExecuteUbergraph_ABP-MicroUzi(int32_t EntryPoint); // Function ABP-MicroUzi.ABP-MicroUzi_C.ExecuteUbergraph_ABP-MicroUzi // (Final|UbergraphFunction) // @ game+0x2bad3b0
};
