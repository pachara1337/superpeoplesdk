...
// Size: 0x2cff6c5c (Inherited: 0x00)
struct FAnimationBudgetAllocatorParameters {
	...
	int32_t NonRenderedUnitProcessMethod; // 0x50(0x04)
	int32_t NonRenderedUnitTickRate; // 0x54(0x04)
	bool bClampTickRateOnURO; // 0x58(0x01)
	bool bForceInterpolateSkippedComponentOnScreen; // 0x59(0x01)
	char pad_5A[0x2cff6c02]; // 0x5a(0x2cff6c02)
};
