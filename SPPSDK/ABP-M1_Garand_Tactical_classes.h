...
struct UABP-M1_Garand_Tactical_C : UBravoHotelAnimInstanceWeapon {
	...
	void AnimGraph(struct FPoseLink& AnimGraph); // Function ABP-M1_Garand_Tactical.ABP-M1_Garand_Tactical_C.AnimGraph // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x2bad3b0
	void ExecuteUbergraph_ABP-M1_Garand_Tactical(int32_t EntryPoint); // Function ABP-M1_Garand_Tactical.ABP-M1_Garand_Tactical_C.ExecuteUbergraph_ABP-M1_Garand_Tactical // (Final|UbergraphFunction) // @ game+0x2bad3b0
};
