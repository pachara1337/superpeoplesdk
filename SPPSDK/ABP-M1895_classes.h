...
struct UABP-M1895_C : UBravoHotelAnimInstanceWeapon {
	...
	void AnimGraph(struct FPoseLink& AnimGraph); // Function ABP-M1895.ABP-M1895_C.AnimGraph // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x2bad3b0
	void ExecuteUbergraph_ABP-M1895(int32_t EntryPoint); // Function ABP-M1895.ABP-M1895_C.ExecuteUbergraph_ABP-M1895 // (Final|UbergraphFunction) // @ game+0x2bad3b0
};
