...
struct FPaperFlipbookKeyFrame {
	...
	char pad_C[0x2cff6d04]; // 0x0c(0x2cff6d04)
};
...
struct FPaperTileMetadata {
	...
	char pad_44[0x2cffe904]; // 0x44(0x2cffe904)
};
...
struct FSpriteGeometryCollection {
	...
	char pad_2C[0x2cffdf04]; // 0x2c(0x2cffdf04)
};
...
struct FSpriteDrawCallRecord {
	...
	char pad_4C[0x2cff6984]; // 0x4c(0x2cff6984)
};
