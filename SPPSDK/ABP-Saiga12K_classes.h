...
struct UABP-Saiga12K_C : UBravoHotelAnimInstanceWeapon {
	...
	void AnimGraph(struct FPoseLink& AnimGraph); // Function ABP-Saiga12K.ABP-Saiga12K_C.AnimGraph // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x2bad3b0
	void ExecuteUbergraph_ABP-Saiga12K(int32_t EntryPoint); // Function ABP-Saiga12K.ABP-Saiga12K_C.ExecuteUbergraph_ABP-Saiga12K // (Final|UbergraphFunction) // @ game+0x2bad3b0
};
