...
struct UABP-Mini14_C : UBravoHotelAnimInstanceWeapon {
	...
	void AnimGraph(struct FPoseLink& AnimGraph); // Function ABP-Mini14.ABP-Mini14_C.AnimGraph // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x2bad3b0
	void ExecuteUbergraph_ABP-Mini14(int32_t EntryPoint); // Function ABP-Mini14.ABP-Mini14_C.ExecuteUbergraph_ABP-Mini14 // (Final|UbergraphFunction) // @ game+0x2bad3b0
};
