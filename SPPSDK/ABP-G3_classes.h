...
struct UABP-G3_C : UBravoHotelAnimInstanceWeapon {
	...
	void AnimGraph(struct FPoseLink& AnimGraph); // Function ABP-G3.ABP-G3_C.AnimGraph // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x2bad3b0
	void ExecuteUbergraph_ABP-G3(int32_t EntryPoint); // Function ABP-G3.ABP-G3_C.ExecuteUbergraph_ABP-G3 // (Final|UbergraphFunction) // @ game+0x2bad3b0
};
