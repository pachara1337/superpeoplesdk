...
// Size: 0x2cffe001 (Inherited: 0x00)
struct FLandscapeLayerBrush {
	char pad_0[0x2cffe001]; // 0x00(0x2cffe001)
};
...
// Size: 0x2cff6110 (Inherited: 0x00)
struct FWeightmapLayerAllocationInfo {
	...
	char pad_A[0x2cff6106]; // 0x0a(0x2cff6106)
};
...
struct FGrassVariety {
	...
	enum class ECullDistancePreset CullDistancePreset; // 0x14(0x01)
	bool bOverrideCullDistance; // 0x15(0x01)
	char pad_16[0x2]; // 0x16(0x02)
	struct FPerPlatformInt StartCullDistance; // 0x18(0x04)
	struct FPerPlatformInt EndCullDistance; // 0x1c(0x04)
	int32_t MinLOD; // 0x20(0x04)
	enum class EGrassScaling Scaling; // 0x24(0x01)
	char pad_25[0x3]; // 0x25(0x03)
	struct FFloatInterval ScaleX; // 0x28(0x08)
	struct FFloatInterval ScaleY; // 0x30(0x08)
	struct FFloatInterval ScaleZ; // 0x38(0x08)
	bool RandomRotation; // 0x40(0x01)
	bool AlignToSurface; // 0x41(0x01)
	bool bUseLandscapeLightmap; // 0x42(0x01)
	struct FLightingChannels LightingChannels; // 0x43(0x01)
	bool bReceivesDecals; // 0x44(0x01)
	bool bCastDynamicShadow; // 0x45(0x01)
	bool bKeepInstanceBufferCPUCopy; // 0x46(0x01)
	char pad_47[0x2cff6901]; // 0x47(0x2cff6901)
};
...
struct FLandscapeSplineConnection {
	...
	char pad_9[0x2cffea07]; // 0x09(0x2cffea07)
};
...
struct FLandscapeSplineMeshEntry {
	...
	char pad_37[0x2cff6901]; // 0x37(0x2cff6901)
};
...
struct FLayerBlendInput {
	...
	char pad_5C[0x2cff6900]; // 0x5c(0x2cff6900)
};
