...
struct UABP-M200_C : UBravoHotelAnimInstanceWeapon {
	...
	void AnimGraph(struct FPoseLink& AnimGraph); // Function ABP-M200.ABP-M200_C.AnimGraph // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x2bad3b0
	void ExecuteUbergraph_ABP-M200(int32_t EntryPoint); // Function ABP-M200.ABP-M200_C.ExecuteUbergraph_ABP-M200 // (Final|UbergraphFunction) // @ game+0x2bad3b0
};
