...
struct UABP-M40A1_C : UBravoHotelAnimInstanceWeapon {
	...
	void AnimGraph(struct FPoseLink& AnimGraph); // Function ABP-M40A1.ABP-M40A1_C.AnimGraph // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x2bad3b0
	void ExecuteUbergraph_ABP-M40A1(int32_t EntryPoint); // Function ABP-M40A1.ABP-M40A1_C.ExecuteUbergraph_ABP-M40A1 // (Final|UbergraphFunction) // @ game+0x2bad3b0
};
