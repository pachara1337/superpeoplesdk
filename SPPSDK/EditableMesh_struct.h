...
struct FAdaptorPolygon2Group {
	...
	char pad_C[0x2cff693c]; // 0x0c(0x2cff693c)
};
...
// Size: 0x2cffd560 (Inherited: 0x00)
...
struct FSubdividedWireEdge {
	...
	char pad_8[0x2cff6a04]; // 0x08(0x2cff6a04)
};
...
struct FSubdividedQuad {
	...
	char pad_D0[0x2cff6900]; // 0xd0(0x2cff6900)
};
