...
struct UABP-M9_C : UBravoHotelAnimInstanceWeapon {
	...
	void AnimGraph(struct FPoseLink& AnimGraph); // Function ABP-M9.ABP-M9_C.AnimGraph // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x2bad3b0
	void ExecuteUbergraph_ABP-M9(int32_t EntryPoint); // Function ABP-M9.ABP-M9_C.ExecuteUbergraph_ABP-M9 // (Final|UbergraphFunction) // @ game+0x2bad3b0
};
