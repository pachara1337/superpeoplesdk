...
struct UABP-C1911_C : UBravoHotelAnimInstanceWeapon {
	...
	void AnimGraph(struct FPoseLink& AnimGraph); // Function ABP-C1911.ABP-C1911_C.AnimGraph // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x2bad3b0
	void ExecuteUbergraph_ABP-C1911(int32_t EntryPoint); // Function ABP-C1911.ABP-C1911_C.ExecuteUbergraph_ABP-C1911 // (Final|UbergraphFunction) // @ game+0x2bad3b0
};
