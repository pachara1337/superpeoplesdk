...
struct UABP-MP5_C : UBravoHotelAnimInstanceWeapon {
	...
	void AnimGraph(struct FPoseLink& AnimGraph); // Function ABP-MP5.ABP-MP5_C.AnimGraph // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x2bad3b0
	void ExecuteUbergraph_ABP-MP5(int32_t EntryPoint); // Function ABP-MP5.ABP-MP5_C.ExecuteUbergraph_ABP-MP5 // (Final|UbergraphFunction) // @ game+0x2bad3b0
};
