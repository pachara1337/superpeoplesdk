...
struct UABP-DesertEagle_C : UBravoHotelAnimInstanceWeapon {
	...
	void AnimGraph(struct FPoseLink& AnimGraph); // Function ABP-DesertEagle.ABP-DesertEagle_C.AnimGraph // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x2bad3b0
	void ExecuteUbergraph_ABP-DesertEagle(int32_t EntryPoint); // Function ABP-DesertEagle.ABP-DesertEagle_C.ExecuteUbergraph_ABP-DesertEagle // (Final|UbergraphFunction) // @ game+0x2bad3b0
};
