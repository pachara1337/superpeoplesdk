...
// Size: 0x2cff6704 (Inherited: 0x00)
struct FAIRequestID {
	uint32_t RequestID; // 0x00(0x04)
	char pad_4[0x2cff6700]; // 0x04(0x2cff6700)
};
...
// Size: 0x2d002e38 (Inherited: 0x2cff6928)
struct FAIDataProviderTypedValue : FAIDataProviderValue {
	struct UObject* PropertyType; // 0x28(0x08)
	char pad_2CFF6930[0xc508]; // 0x2cff6930(0xc508)
};

// ScriptStruct AIModule.AIDataProviderBoolValue
// Size: 0x2cff6940 (Inherited: 0x2d002e38)
...
// Size: 0x2cff6938 (Inherited: 0x2cff6928)
struct FAIDataProviderStructValue : FAIDataProviderValue {
	char pad_2CFF6928[0x10]; // 0x2cff6928(0x10)
};
...
struct FIntervalCountdown {
	...
	char pad_4[0x2cff6a04]; // 0x04(0x2cff6a04)
};
...
struct FEnvQueryInstanceCache {
	...
	char pad_8[0x2cff6980]; // 0x08(0x2cff6980)
};
...
struct FEnvQueryRequest {
	...
	char pad_18[0x2cffe950]; // 0x18(0x2cffe950)
};
...
struct FEQSParametrizedQueryExecutionRequest {
	...
	char pad_4D[0x2cff6c03]; // 0x4d(0x2cff6c03)
};
...
struct FEnvQueryResult {
	...
	char pad_34[0x2cff690c]; // 0x34(0x2cff690c)
};
